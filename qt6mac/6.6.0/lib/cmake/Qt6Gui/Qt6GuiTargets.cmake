...
set_target_properties(Qt6::Gui PROPERTIES
  ...
  INTERFACE_LINK_LIBRARIES "Qt6::Core;\$<LINK_ONLY:Qt6::CorePrivate>;\$<LINK_ONLY:Qt6::PlatformModuleInternal>;\$<\$<AND:\$<NOT:\$<STREQUAL:\$<TARGET_PROPERTY:TYPE>,STATIC_LIBRARY>>,\$<NOT:\$<BOOL:\$<TARGET_PROPERTY:Qt6::Platform,_qt_link_order_matters>>>,\$<NOT:\$<BOOL:\$<TARGET_PROPERTY:_qt_object_libraries_finalizer_mode>>>,\$<BOOL:TRUE>>:\$<TARGET_OBJECTS:Qt6::Gui_resources_1>>;Qt6::Gui_resources_1;\$<\$<AND:\$<NOT:\$<STREQUAL:\$<TARGET_PROPERTY:TYPE>,STATIC_LIBRARY>>,\$<NOT:\$<BOOL:\$<TARGET_PROPERTY:Qt6::Platform,_qt_link_order_matters>>>,\$<NOT:\$<BOOL:\$<TARGET_PROPERTY:_qt_object_libraries_finalizer_mode>>>,\$<BOOL:TRUE>>:\$<TARGET_OBJECTS:Qt6::Gui_resources_2>>;Qt6::Gui_resources_2;WrapOpenGL::WrapOpenGL;-framework AppKit;-framework AppKit;-framework Carbon;-framework ImageIO;-framework CoreFoundation;-framework CoreGraphics;-framework CoreText;-framework Foundation;-framework Foundation;\$<LINK_ONLY:WrapPNG::WrapPNG>;\$<LINK_ONLY:WrapHarfbuzz::WrapHarfbuzz>;\$<LINK_ONLY:WrapFreetype::WrapFreetype>;\$<LINK_ONLY:WrapFreetype::WrapFreetype>;\$<LINK_ONLY:WrapZLIB::WrapZLIB>;\$<LINK_ONLY:Qt6::DBus>;-framework Metal"
