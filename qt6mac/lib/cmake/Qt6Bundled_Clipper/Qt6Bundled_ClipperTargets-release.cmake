...
set_target_properties(Qt6::Bundled_Clipper PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libQt6Bundled_Clipper.a"
  )

list(APPEND _cmake_import_check_targets Qt6::Bundled_Clipper )
list(APPEND _cmake_import_check_files_for_Qt6::Bundled_Clipper "${_IMPORT_PREFIX}/lib/libQt6Bundled_Clipper.a" )
