...
set_target_properties(Qt6::BundledLibjpeg12bits PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/Qt6BundledLibjpeg12bits.lib"
  )

list(APPEND _cmake_import_check_targets Qt6::BundledLibjpeg12bits )
list(APPEND _cmake_import_check_files_for_Qt6::BundledLibjpeg12bits "${_IMPORT_PREFIX}/lib/Qt6BundledLibjpeg12bits.lib" )
